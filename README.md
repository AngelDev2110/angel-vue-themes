...
Most palette generators build on HSL, where equal lightness doesn't mean equal *perceived* brightness (a 50%-lightness yellow and blue don't look equally bright). That makes generated harmonies look unbalanced and contrast math unreliable.
...
- [ ] Dominant color extraction from an uploaded image
- [ ] APCA contrast comparison (optional)
